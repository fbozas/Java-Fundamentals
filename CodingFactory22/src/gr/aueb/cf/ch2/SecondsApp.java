...
/**
 * Διαβάζει ώρες, λεπτά και δεύτερα και μετατρέπει σε δευτερόλεπτα
 */
public class SecondsApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf(Locale.US, "%d hours, %d minutes, %d seconds = %,d total seconds",
                inputHours, inputMinutes, inputSeconds, totalSeconds); // Now the total seconds separator will be comma
    }
}
